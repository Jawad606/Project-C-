...
void main()
{
	...
	{
		cout << "\n\n\n\n\n\t\t\t**** Defender RACER ****";
		cout << "\n\n\tLong long ago ciit wah was attacked by terrorists.";
		cout << "\n\n\tEvery student and Employee were";
		cout << "\n\n\tkilled except the beautiful princess sheela and you";
		cout << "\n\n\twho survived. Terrorists want to kill her and she is in your";
		cout << "\n\n\tcar right now. If you have the guts save her from terrorists";
		cout << "\n\n\tcars and marry her.";
		cout << " \n\n\t\t\t\t Play this GAME & enjoy it................";
		getch();
	}
	cout << "\n\t\t\t\t______________________________";
	cout << "\n\t\t\t\tThis Project of car war in c++";
	cout << "\n\t\t\t\t^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^";
	cout << "\n\t\t\t\t";
	delay(2004);
	for (int m = 1; m < 25; m++)
