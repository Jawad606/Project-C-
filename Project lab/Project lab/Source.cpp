#include <iostream>
using namespace std;
int main() {  const double tax1 = 2000.00; 
// first tax increment 30k-50k
const double tax2 = 10000.00;
// second increment 50k-100k 
const double tax3 = 30000.00;
// thrid increment 100k-200k 
const double tax4 = 17500.00;
// fourth increment 200k-250k 
...
{
	taxedInc = ((income - 50000.00) * .20) + tax1;
	//calculates tax
	afterTax = (income - taxedInc);
	cout << "Your income before taxes is " << income << "." << endl;
...
{ taxedInc = ((income - 100000.00) * .30) + tax1 + tax2; 
//calculates tax
afterTax = (income - taxedInc);
cout << "Your income before taxes is " << income << "." << endl;
cout << "Your income after taxes is " << afterTax << "." << endl;
...
{ taxedInc =((income - 200000.00) * .35) + tax1 + tax2 + tax3;
//finds tax amount
afterTax = (income -taxedInc);
cout << "Your income before taxes is " << income << "." << endl;
cout << "Your income after taxes is " << afterTax << "." << endl;
...
{ taxedInc = ((income - 250000.00) * .40) + tax1 + tax2 + tax3 + tax4; 
//finds tax amount
afterTax = (income - taxedInc);
cout << "Your income before taxes is " << income << "." << endl;
cout << "Your income after taxes is " << afterTax << "." << endl;
cout << "Your deducted amount is " << taxedInc << "." << endl; } 
 else cout << "You have entered an unuseable number. Please restart the program and enter a positive number " << endl; 
return 0; }